...
<template>
  <div class="pointer-events-auto">
    <button
      ...
      @click="toggleDark()"
      class="group rounded-full bg-white/90 px-3 py-3 shadow-lg shadow-zinc-800/5 ring-2 ring-zinc-900/5 backdrop-blur transition dark:bg-zinc-800/90 dark:ring-white/10 dark:hover:ring-white/20"
    >
      <svg
        viewBox="0 0 24 24"
        stroke-width="1.5"
